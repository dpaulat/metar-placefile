...
function gen_header() {
	global $Version;
	$title = "METAR Dewpoints - Nationwide";
  ...
  */
  ...
  if (isset($M['ddewpt'])) {
    ...
    if ($dewpt <= 9) {
      ...
      $color = "208 206 48"; // Light Blue
    } elseif ($dewpt <= 29) {
      $color = "217 217 51"; // Yellow
    } elseif ($dewpt <= 39) {
      $color = "243 243 76"; // Yellow
    } elseif ($dewpt <= 49) {
      $color = "158 255 125"; // Light Green
    } elseif ($dewpt <= 59) {
      $color = "76 255 76"; // Mid Green
    } elseif ($dewpt <= 69) {
      $color = "61 199 61"; // Green
    } elseif ($dewpt <= 79) {
      $color = "36 164 33"; // Dark Green
    } elseif ($dewpt <= 89) {
      $color = "28 99 46"; // Darkest Green
    } elseif ($dewpt <= 99) {
      $color = "28 99 46"; // Darkest Green
    } elseif ($dewpt <= 109) {
      $color = "28 99 46"; // Darkest Green
    } else {
      $color = "148 80 80"; // Darker Red
    }

    $output .= "Color: $color\n";
    $output .= "Text: 0, 0, 1, $dewpt, \"$popup\"\n";
  }
